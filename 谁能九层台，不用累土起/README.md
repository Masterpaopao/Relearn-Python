...
首先恭喜你进入了字典的世界，并探索到了它的奥妙，这个时候我提供一份作业，来锻炼你们的字典与json实战能力，这份作业的原型是我在实习时处理数据的python脚本，通宵写完的，难度估计也不是很大。

这份作业的详细情况会在assignment目录里面提供，请各位前往完成挑战。
...
来看看最终的五大数据结构的整理大图吧，我还会在xmind目录中提供源xmind文件，建议亲自下载细细品读！
